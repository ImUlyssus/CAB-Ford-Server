...
const createChangeRequestTableQuery = `
  CREATE TABLE IF NOT EXISTS ChangeRequest (
    ...
    ftm_schedule_change VARCHAR(1390) DEFAULT NULL,
    aat_schedule_change VARCHAR(1390) DEFAULT NULL,
    fsst_schedule_change VARCHAR(1390) DEFAULT NULL,
    aat_requestor VARCHAR(50) DEFAULT NULL,
    ftm_requestor VARCHAR(50) DEFAULT NULL,
    fsst_requestor VARCHAR(50) DEFAULT NULL,
    ...
    ftm_crq VARCHAR(380) DEFAULT NULL,
    aat_crq VARCHAR(380) DEFAULT NULL,
    fsst_crq VARCHAR(380) DEFAULT NULL,
    ...
    cancel_change_reason VARCHAR(500) DEFAULT NULL,
    reschedule_reason VARCHAR(500) DEFAULT NULL,
    lesson_learnt VARCHAR(500) DEFAULT NULL,
